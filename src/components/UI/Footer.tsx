      ...
      <div className="bg-amber-500/10 border-y border-amber-500/20 py-4 px-6 sm:px-8 text-amber-200 text-xs">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <p className="leading-relaxed tracking-wide">
            ...
            Please be aware that payments are strictly handled via secure application routers. Do not process transactions through unverified outbound source hooks.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-10 text-xs sm:text-sm">
        <div>
          ...
          <p className="leading-relaxed text-slate-400 font-light">
            Architecting high-fidelity, customized boutique luxury travel ecosystems based on structural travel schemas.
          </p>
        </div>
        <div>
